...
public class TrainData {
    ...
    //
    // C++:  Mat cv::ml::TrainData::getTrainSamples(int layout_point_mark = ROW_SAMPLE, bool compressSamples = true, bool compressVars = true)
    //

    /**
     * Returns matrix of train samples
     *
     *     @param layout The requested layout_point_mark. If it's different from the initial one, the matrix is
    ...
    //
    // C++: static Mat cv::ml::TrainData::getSubMatrix(Mat matrix, Mat idx, int layout_point_mark)
    //
    ...
    //
    // C++: static Ptr_TrainData cv::ml::TrainData::create(Mat samples, int layout_point_mark, Mat responses, Mat varIdx = Mat(), Mat sampleIdx = Mat(), Mat sampleWeights = Mat(), Mat varType = Mat())
    //
